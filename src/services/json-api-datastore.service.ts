...
export class JsonApiDatastore {
    ...
    hasManyLink<T extends JsonApiModel>(modelType: ModelType<T>, url: string, params?: any,
                                        headers?: Headers): Observable<CollectionModel<T>> {
        let options: RequestOptions = this.getOptions(headers);
    ...
    belongsToLink<T extends JsonApiModel>(modelType: ModelType<T>, url: string, params?: any,
                                          headers?: Headers): Observable<DocumentModel<T>> {
        let options: RequestOptions = this.getOptions(headers);
